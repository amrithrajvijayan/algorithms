package preparations.tree.binary_indexed_fenwick_tree;
...
public class BinaryIndexedTreeOrFenwickTree { 
	...
	public static void main(String args[]) {
		...
		int n = freq.length;
		BinaryIndexedTreeOrFenwickTree tree = new BinaryIndexedTreeOrFenwickTree();

		// Build BI tree from given array
